...
/**
 * @brief agent for the Gantry
 * This class is the agent for the Gantry. The Gantry receives message from feeder to supply parts.
 * It supplies the parts whenever it has enough parts available.
 * @author Kevin Macwan
 * @version 0
 */
