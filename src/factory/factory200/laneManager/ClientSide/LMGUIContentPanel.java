 ...
 */
class LMGUIContentPanel extends JPanel{
	 ...
	 * @param border : TitledBorder
	 */
	public LMGUIContentPanel(int counter, TitledBorder border){
	 ...
	 * @param border : TitledBorder
	 */
	public LMGUIContentPanel(JRadioButton button1, JRadioButton button2, TitledBorder border){		
		setPreferredSize(new Dimension(250,70));
