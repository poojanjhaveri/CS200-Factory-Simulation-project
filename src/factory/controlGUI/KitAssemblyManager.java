       /**
This class keeps track of everything that will be visible to the Kit Assembly Manager. This includes the graphics panel and the GUI panel. 
The graphics panel will show the kit stand, the camera, the kit delivery station, the parts robot, the kit robot, and the completed/empty kits. 
The GUI panel will allow the Kit Assembly Manager to break any of the components that are contained in this window.
<img url="addthis.jpg" />
<img url="addthis.jpg" />
@brief keeps track of everything that will be visible to the Kit Assembly Manager
@author Deepa Borkar
	*/
...
changes the panel based on what the user clicks
	*/
	...
	/**
declares objects within the class and sets the states of each of the objects
	*/
