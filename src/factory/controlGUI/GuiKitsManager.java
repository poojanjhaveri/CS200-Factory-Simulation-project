 ...
 */
public class GUIKitsManager extends Manager implements ActionListener {
...
public class GuiKitsManager extends JFrame implements ActionListener, Manager {
        ...
        /**
         * Creates the Kit ( triggered from actionperformed when create_kit
         * button is clicked ).Passes the contents of current kit ie kit name ,
         * items in the kit to the server.
         */
        void createKit() {
        }
        ...
        /**
         * ( triggered from actionperformed when _update_kit is clicked ) and
         * sends it to the Server. Deletes the kit selected by the user and
         * sends the updated list of kits to the server.( triggered from
         * actionperformed when delete_kit is clicked )
         */
        void deleteKit() {
        }
