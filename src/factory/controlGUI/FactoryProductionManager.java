...
@author Matt Kane
@brief selects active kit production routines, how many of each kit to produce, and also will control non-normative scenario simulation
...
/**
once user clicks this menu item, set the GUI panels invisible and the graphic panel visible
*/
void displayGraphics()
{
}
/**
once user clicks this menu item, set the NonNormative and FPMGraphics panels invisible and the FPMGUI panel visible
*/
void displayFPMGUI() 
{
}
/**
once user clicks this menu item, set the FPMGUI and FPMGraphics panels invisible and the NonNormative panel visible
*/
void displayFPMGUI() {
}
/**
...
/**
@brief Controls Kit selection and Factory ON/OFF
 ...
 */
 ...
 public void repaint(){}
 /**
 change status of robot, feeders, purge station and bins by coping data from the object sent by server
 */
 void sentFromServer(){}
...
/**
@brief Controls execution of non-normative scenarios
