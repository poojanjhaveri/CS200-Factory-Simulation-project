...
//Deepa Borkar
/**
 * keeps track of what is on the kit delivery station interacts with the kit
 * robot because the kit robot takes empty kits off the station and puts on
 * finished kits on the station to be taken away needs to know when an empty kit
 * is needed on the kit stand
 *
 * @brief
 * @author Deepa Borkar
 */
