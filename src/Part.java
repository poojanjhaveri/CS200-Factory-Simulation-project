...
void createPart() - creates a part based on form data; sends data to server
void updatePart() - updates part data and sends data to server
void deletePart(int partNumber) - deletes the part with the specified part number and sends data to the server
void sendToServer() - pass part data to FCS / server
