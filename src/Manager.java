...
/**
The Manager plays a pivotal role in server interaction by standardizing the methods used to send up data to the FactoryProductionManager simulation GUI.
